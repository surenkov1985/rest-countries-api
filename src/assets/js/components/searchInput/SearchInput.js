...
export default function SearchInput({onChange, val}) {
	...
	return (
		<label htmlFor="" className="content__search-container">
			...
			<input type="search" className="content__search" placeholder="Search for a country..." value={val} onChange={(e) => onChange(e)}/>
		</label>
	)
}